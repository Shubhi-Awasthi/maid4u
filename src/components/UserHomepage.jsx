...
import './Homepage.css'; // Assuming you want the same styles for consistency
        ...
        <Layout>
            <section className="hero">
                <div className="hero-content">
                    <h1>Welcome Back to Your Trusted Maid Service</h1>
                    <p>Continue finding and booking professional maids with ease.</p>
